...
import OperationsMain from "../component/operationsDashboard/OperationsMain";
// import TicketApproval from "../component/operationsDashboard/TicketApproval";
// import MyOpsTickets from "../component/operationsDashboard/MyOpsTickets";
// import Performance from "../component/operationsDashboard/Performance";
...
const OperationsDashboard = () => {
  ...
  const menuItems = [
    ...
    { label: "Ticket Approval", value: "approval", icon: CheckSquare },
    { label: "My Tickets", value: "my-tickets", icon: ClipboardList },
    { label: "Performance", value: "performance", icon: BarChart2 },
  ];
    ...
    <div className="flex h-screen bg-bgDark text-textPrimary">
      ...
      <div className="w-64 bg-bgLight border-r border-border flex flex-col fixed h-full">
        <div className="h-16 flex items-center px-6 border-b border-border">
          <h1
            onClick={() => navigate("/")}
            className="text-xl font-bold text-operations cursor-pointer"
          >
            Helpdesk
          </h1>
        </div>
        ...
        <div className="p-4 border-t border-border">
          <button
            onClick={() => navigate("/")}
            className="flex items-center gap-3 px-4 py-2 w-full text-left text-operations rounded-lg hover:bg-bgDark"
          >
      ...
      <div className="flex-1 ml-64 flex flex-col min-h-screen">
        ...
        <header className="h-16 bg-bgLight border-b border-border flex items-center justify-between px-6 sticky top-0 z-10">
          ...
          <div className="relative">
            ...
            >
              <div className="w-10 h-10 rounded-full bg-operations/10 flex items-center justify-center overflow-hidden">
                <img
        ...
        <main className="flex-1 p-6 overflow-y-auto bg-bgDark">
          {activeMenu === "dashboard" && <OperationsMain />}
          {/* {activeMenu === "approval" && <TicketApproval />}
          {activeMenu === "my-tickets" && <MyOpsTickets />}
